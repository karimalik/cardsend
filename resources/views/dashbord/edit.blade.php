...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <h1 class="app-page-title">Modification</h1>
        <hr class="mb-4">
        <div class="alert alert-warning" role="alert">
            <i class="fa fa-warning"></i>&nbsp; Modification des informations du vehicule &quot;<strong
            ...
            <div class="col-12 col-md-12">
                <div class="app-card app-card-settings shadow-sm p-4">
                    <div class="app-card-body">
                        <form class="settings-form" method="POST" action="{{ route('cars.update', $car->id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre_place" name="nombre_place" placeholder="5"
                                    value="{{ $car->nombre_place }}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" placeholder="Inserer une description" id="description"
                                    name="description" style="height: 100px">{{ $car->description }}</textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn app-btn-primary">Modifier</button> <a
