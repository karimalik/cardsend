            ...
            <div class="col-6 col-md-4 col-xl-3 col-xxl-2">
                <div class="app-card app-card-doc shadow-sm h-100">
                    ...
                    <div class="app-card-body p-3 has-card-actions">
                        ...
                        <h4 class="app-doc-title truncate mb-0"><a href="#file-link">Curabitur ac purus
                                venenatis</a></h4>
                        <div class="app-doc-meta">
                            <ul class="list-unstyled mb-0">
            ...
            <div class="col-6 col-md-4 col-xl-3 col-xxl-2">
                <div class="app-card app-card-doc shadow-sm h-100">
                    ...
                    <div class="app-card-body p-3 has-card-actions">
                        ...
                        <h4 class="app-doc-title truncate mb-0"><a href="#file-link">Sed eleifend non libero
                                congue fringilla</a></h4>
                        <div class="app-doc-meta">
                            <ul class="list-unstyled mb-0">
                                <li><span class="text-muted">Type:</span> Text</li>
            ...
            <div class="col-6 col-md-4 col-xl-3 col-xxl-2">
                <div class="app-card app-card-doc shadow-sm h-100">
                    ...
                    <div class="app-card-body p-3 has-card-actions">
                        ...
                        <h4 class="app-doc-title truncate mb-0"><a href="#file-link">Duis venenatis mattis
                                neque</a></h4>
                        <div class="app-doc-meta">
                            <ul class="list-unstyled mb-0">
            ...
            <div class="col-6 col-md-4 col-xl-3 col-xxl-2">
                <div class="app-card app-card-doc shadow-sm h-100">
                    ...
                    <div class="app-card-body p-3 has-card-actions">
                        ...
                        <h4 class="app-doc-title truncate mb-0"><a href="#file-link">Nullam ornare urna sed</a>
                        </h4>
                        <div class="app-doc-meta">
                            <ul class="list-unstyled mb-0">
            ...
            <div class="col-6 col-md-4 col-xl-3 col-xxl-2">
                <div class="app-card app-card-doc shadow-sm h-100">
                    ...
                    <div class="app-card-body p-3 has-card-actions">
                        ...
                        <h4 class="app-doc-title truncate mb-0"><a href="#file-link">Aenean scelerisque </a>
                        </h4>
                        <div class="app-doc-meta">
                            <ul class="list-unstyled mb-0">
            ...
            <div class="col-6 col-md-4 col-xl-3 col-xxl-2">
                <div class="app-card app-card-doc shadow-sm h-100">
                    ...
                    <div class="app-card-body p-3 has-card-actions">
                        ...
                        <h4 class="app-doc-title truncate mb-0"><a href="#file-link">Ut viverra leo sapien</a>
                        </h4>
                        <div class="app-doc-meta">
                            <ul class="list-unstyled mb-0">
                                <li><span class="text-muted">Type:</span> Spreadsheet</li>
