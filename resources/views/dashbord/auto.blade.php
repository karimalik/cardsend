                        ...
                        <div class="app-card-actions">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('cars.show', $car->id) }}"><svg
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('cars.edit', $car->id) }}"><svg
                    ...
                    <div class="app-card-body p-3 p-lg-3">
                        <div class="row gx-3 gy-2">
                            <div class="col-8 col-lg-9">
                                ...
                                <div>
                                    Vous n'avez pas encore poster de voiture. Cliquez sur le bouton &quot; Ajouter Une
                                    Voiture &quot; pour pouvoir vendre votre automobile.
                                </div>
                            </div>
                        </div>
                        <!--//row-->
