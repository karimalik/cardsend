        ...
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('/') }}">Accueil <i
                                class="ion-ios-arrow-forward"></i></a></span> <span>Recherche <i
                            class="ion-ios-arrow-forward"></i></span></p>
                <h1 class="mb-3 bread">Resultats De Vos Recherches</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="ftco-section bg-light">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="car-wrap rounded ftco-animate">
                    ...
                    <div class="text">
                        ...
                        <p class="d-flex mb-0 d-block"><a href="{{ route('booking.show', $car->id) }}"
                                class="btn btn-primary py-2 mr-1">Acheter</a> <a
                                href="{{ route('booking.show', $car->id) }}"
            ...
            @empty
            <h5>
                Nous n'avons trouver aucune voiture corespondant à votre recherche 😢.
            </h5>
            @endforelse
        </div>
        {{-- <p>{{ $cars->links() }}</p> --}}
